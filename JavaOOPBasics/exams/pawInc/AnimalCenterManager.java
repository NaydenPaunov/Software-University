...
public class AnimalCenterManager {
   ...
   public void printStatistics(){
       ...
       sb.append(String.format("Animals Awaiting Adoption: %s\n",getAwaitingAddoptionCount()));
       sb.append(String.format("Animals Awaiting Cleansing: %s\n",getAwaitingCleansingCount()));
    ...
    public Integer getAwaitingAddoptionCount() {
        Integer count = this.adoptionCenters.values().stream()
    ...
    public Integer getAwaitingCleansingCount() {
        Integer count = this.cleansingCenters.values().stream()
                .flatMap(c -> c.getAnimals().stream())
                .collect(Collectors.toList())
                .size();
        return  count;
